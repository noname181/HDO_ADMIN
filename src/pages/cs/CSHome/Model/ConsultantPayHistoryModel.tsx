...
const ConsultantPayHistoryModel = ({
  state,
  setState,
          ...
          <CPHContainer>
            ...
            <table className="nl-tbl-detail">
              <tbody>
                ...
                <tr>
                  ...
                  <th>충전기 ID</th>
                  <td>{payHisData?.sb_charger_memb?.chg_charger_id}</td>
                </tr>
                <tr>
                  <th>회원구분</th>
                  <td>
                ...
                <tr>
                  <th>충전 요청</th>
                  <td>
                    {payHisData?.chargingLogs?.desired_kwh
                      ? new Intl.NumberFormat('en-US').format(
                          payHisData?.chargingLogs?.desired_kwh,
                        ) + 'kWh'
                      : ''}
            ...
            <table className="nl-tbl-detail">
              <tbody>
                <tr>
                  <th>카드사</th>
                  <td>{payHisData?.issuer_nm ?? dataType10?.issuer_nm}</td>
                  <th>카드번호</th>
...
export default ConsultantPayHistoryModel;
