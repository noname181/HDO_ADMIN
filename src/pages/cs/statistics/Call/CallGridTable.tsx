...
const CallGridTable = ({
  ...
  const requestAddData = async () => {
    ...
    const url = `/v1/web/cs-callList?rpp=${queryState.rpp}&page=${queryState.page}&startDate=${queryState.startDate}&endDate=${queryState.endDate}&gubun=callLogList`;
  ...
  const columnLayout: IGrid.Column[] = [
    ...
    {
      dataField: 'ringingCount',
      headerText: '연결시도',
    },
    {
      dataField: 'hangupCount',
      headerText: '응대호',
    },
    {
      dataField: 'giveupCount',
      headerText: '포기 호',
    },
    {
      dataField: 'rate',
