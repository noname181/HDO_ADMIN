...
import RefundGridHeader from './RefundGridHeader';
import RefundGridTable from './RefundGridTable';
...
const RefundGrid = () => {
  ...
  const {
    ...
    url: `/v1/web/cs-callList?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&startDate=${queryState.startDate}&endDate=${queryState.endDate}&counselor=${queryState.counselor}&gubun=refund`,
  });
  const search = () => {
    setQueryState({
      ...queryState,
