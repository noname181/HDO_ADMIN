...
const MonthlySettlementPopUp = ({
  ...
  const {
    ...
    url: `/v1/MonthlySettlement?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&division=${queryState.division}&select=${queryState.searchKey}&search=${queryState.searchVal}&startDate=${queryState.startDate}&endDate=${queryState.endDate}&area=${queryState.area}&branch=${queryState.branch}`,
  });
  ...
  const requestAddData = async () => {
    ...
    const url = `/v1/MonthlySettlement?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&division=${queryState.division}&select=${queryState.searchKey}&search=${queryState.searchVal}&startDate=${queryState.startDate}&endDate=${queryState.endDate}&area=${queryState.area}&branch=${queryState.branch}`;
...
export default MonthlySettlementPopUp;
