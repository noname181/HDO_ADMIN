...
import ConfigLogGridHeader from './PaymentLogGridHeader';
import { alertModalState } from 'recoil/modalState';
import { useRecoilState } from 'recoil';
import { PaymentLogGridTable } from './PaymentLogGridTable';
...
export const PaymentLog = () => {
  ...
  const {
    ...
    url: `/v1/admin/logs/payments?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&startTime=${queryState.startDate}&endTime=${queryState.endDate}`,
  });
  const search = () => {
    setQueryState({
      ...queryState,
