...
import ChargerStatusHistoryGrid from './ChargerStatusHistoryGrid';
...
import ChargerStatusHistoryGridHeader from './ChargerStatusHistoryGridHeader';
...
export const ChargerStatusHistory = () => {
  ...
  const {
    ...
    url: `/v1/charger-status-history?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&startDate=${queryState.startDate}&endDate=${queryState.endDate}&searchVal=${queryState.searchVal}&searchKey=${queryState.searchKey}&status=${queryState.status}`,
  });
  const search = () => {
    setQueryState({
      ...queryState,
  ...
  return (
    <>
      <DefaultDiv>
        <ChargerStatusHistoryGridHeader
