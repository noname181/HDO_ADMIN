...
import { GridContainer, Filter, DefaultDiv, GridButton } from 'styles/style';
...
import MessageLogGridHeader from './MessageLogGridHeader';
...
export const MessageLog = () => {
  ...
  const {
    ...
    url:
      ...
      `&searchVal=${queryState.searchVal}&searchKey=${queryState.searchKey}&endDateCreate=${queryState.endDateCreate}&startDateCreate=${queryState.startDateCreate}&returnType=${queryState.returnType}&messageType=MESSAGE&division=${queryState.division}`,
  });
  const search = () => {
    setQueryState({
      ...queryState,
