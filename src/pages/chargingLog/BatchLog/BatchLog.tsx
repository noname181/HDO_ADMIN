...
import BatchLogGridHeader from './BatchLogGridHeader';
import { alertModalState } from 'recoil/modalState';
import { useRecoilState } from 'recoil';
import { BatchLogGrid } from './BatchLogGrid';
...
export const BatchLog = () => {
  ...
  const {
    ...
    url: `/v1/web/batch-log?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&startDate=${queryState.startDate}&endDate=${queryState.endDate}&division=${queryState.division}&status=${queryState.status}`,
  });
  const search = () => {
    setQueryState({
      ...queryState,
