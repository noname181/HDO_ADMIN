...
export const AdTransmissionHistory = ({
  dataId,
  setDataId,
  openDetailModel,
  setOpenDetailModel,
  ...
  const { loading, error, data, refetch, totalCount } = useGetListWt({
    url: `/charger-ocpp-log?rpp=${queryState.rpp}&page=${queryState.page}&odby=${queryState.odby}&division=${queryState.division}&chg_id=${dataId}`,
  });
