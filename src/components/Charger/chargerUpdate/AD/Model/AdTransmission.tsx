...
export const AdTransmission = ({
  ...
  //   console.log('가양 주유소 | 가나다라마바 clicked');
  // };
  // const handleClickBtn2 = () => {
  //   console.log('주유소 명 | 충전기 ID clicked');
  // };
  // const handleClickBtn3 = () => {
  //   console.log('주유소 명 | 충전기 ID 2 clicked');
  // };
  useEffect(() => {
    if (isModalOpen) {
      refetch();
  ...
  return (
    <>
      {isModalOpen && (
        <Modal open={isModalOpen} title="광고 전송" close={handleCloseModal}>
          <StyledForm
            form={form}
            name="AdTransmission"
            colon={false}
